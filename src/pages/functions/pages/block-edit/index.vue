<template>
    <div class="newArticle">
      <div class="acticle-title">
            <i-input autofocus mode="wrapped" placeholder="请输入知识块标题"
              maxlength="10" @change="handleTitle"/>
      </div>
      ...
      <div class="article-edit">
        <div class="article-main">
          <div class='toolbar' @click="format">
            ...
            <i v-if="config.underline" :class="'iconfont icon-zitixiahuaxian ' + (formats.underline ? 'ql-active' : '')" data-name="underline"></i>
            <i v-if="config.strike" :class="'iconfont icon-zitishanchuxian ' + (formats.strike ? 'ql-active' : '')" data-name="strike"></i>
            ...
            <i v-if="config.lineHeight" :class="'iconfont icon-line-height ' + (formats.lineHeight ? 'ql-active' : '')" data-name="lineHeight" data-value="2"></i>
          ...
          <editor id="editor" class="ql-container" :placeholder="placeholder" showImgSize showImgToolbar showImgResize 
            @statuschange="onStatusChange" @ready="onEditorReady" @input="onInput">
          </editor>

        </div>
      </div>
      <i-button class="button" @click="handleEdit" type="success" shape="circle">发布</i-button>
    </div>
</template>
